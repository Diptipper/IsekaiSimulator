...
let OpenWorld = {
    "scene:town:🏬 Town:town.png" : TownData,
...
const goblinEnemy = new Enemy("Goblin Scout", 15, {"Goblin Ear": 1.0, "Potion": 0.2}, new Skills(4, 1, 0, 1));
const wolfEnemy = new Enemy("Dire Wolf", 25, {"Wild Flower": 1.0}, new Skills(6, 2, 0, 2));
...
AppendIntRegEntry("recruit_merc_cond", [
    { 
        condition: { var: "merc_recruited", op: "==", val: false },
    },
]);
AppendIntRegEntry("recruit_healer_cond", [
    { 
        condition: { var: "healer_recruited", op: "==", val: false },
    },
]);
...
Object.assign(OpenWorld, {
    "scene:forest clearing:🪵 Forest clearing:icon.png": {
        ...
        [1000, "Chopping wood...", { "Oak log": 1.0 }, { "woodcutting": 2 }],
    },
    "scene:mining quarry:🪨 Mining quarry:quarry_dark.png": {
        "return:return:🔙 Exit:icon.png": {},
        "harvest:mine ores:⛏️ Mine ores:icon_pickaxe.png" :
        [1000, "Mining rocks...", { "Copper ore": 1.0, "Garnet": 0.1 }, { "mining": 2 }],
...
Object.assign(TownData,{
    "scene:blacksmith:🔨 Blacksmith:icon.png": {
        "return:return:🔙 Exit:icon.png": {},
        "craft:smelt ore:🧱 Smelt ores:icon.png": [1000, "Smelting ores...", { "input:Oak log": 0.5, "input:Copper ore": 1, "output:Copper ingot": 1 }, { "smithing": 1 }],
        "craft:craft dagger:🗡️ Make a dagger:icon.png": [1000, "Crafting...", { "input:Copper ingot": 1, "output:Copper dagger": 1 }, { "smithing": 5 }],
        "craft:craft dagger:🎽 Make a plate armor:icon.png": [1000, "Crafting...", { "input:Copper ingot": 2, "output:Copper plate armor": 1 }, { "smithing": 10 }],
        "craft:craft dagger:👖 Make a plate leggings:icon.png": [1000, "Crafting...", { "input:Copper ingot": 2, "output:Copper plate leggings": 1 }, { "smithing": 10 }],
    },
});
...
const harborMainDlg = {
    "background": "sea.png", "speakers": { "Sailor": ["sailor.png", "(50%,0%)"] },
    "data": [
        ["dialogue","Sailor","Where ya going?", ["Sailor:fade in"]],
        ["question","Sailor","Where ya going?", [] ,{
        ...
        data: {
            ...
            on_finish: {
                ...
                switch_case: {
                    "to island":{
                        actions: [
                            { type: "goto", target: "tropical island" }
                        ]
                    },
                    "nevermind":{
                    },
